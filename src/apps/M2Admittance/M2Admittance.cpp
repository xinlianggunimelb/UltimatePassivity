...
M2Admittance::M2Admittance() {
     ...
     */
     ...
     NewTransition(goToP0State, goToNextState, standbyState);
     ...
     //NewTransition(goToP0State, goToFour, admittance4State);
...
bool M2Admittance::GoToFour::check() {
    //keyboard or joystick press
